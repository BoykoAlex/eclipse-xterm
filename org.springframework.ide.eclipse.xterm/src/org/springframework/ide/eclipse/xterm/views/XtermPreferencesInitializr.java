...
public class XtermPreferencesInitializr extends AbstractPreferenceInitializer {
	...
	public void initializeDefaultPreferences() {
		XtermPlugin.getDefault().getPreferenceStore().setDefault(XtermPlugin.PREFS_DEFAULT_SHELL_CMD, Platform.getOS() == Platform.OS_WIN32 ? "powershell.exe" : "/bin/bash --login");
	}
